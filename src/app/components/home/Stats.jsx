  ...
  return (
    <section className="flex flex-wrap justify-center" style={{ backgroundColor: "#0369a1" }}>
      ...
      <div className="flex-1 border-r border-white/10 px-3 py-5 text-center max-md:basis-1/2">
        <span className="block text-[24px] font-semibold text-sky-200" style={{ fontFamily: "'Playfair Display', serif" }}>
          12k+
        </span>
      ...
      <div className="flex-1 border-r border-white/10 px-3 py-5 text-center max-md:basis-1/2">
        <span className="flex items-center justify-center gap-1 text-[24px] font-semibold text-sky-200" style={{ fontFamily: "'Playfair Display', serif" }}>
          4.8
